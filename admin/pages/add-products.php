                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label>Amount</label>
                                    <input type="number" name="amount" required placeholder="Enter product amount" class="form-control">
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label>Quantity</label>
                                    <input type="number" name="qty" required placeholder="Enter product quantity" class="form-control">
                                </div>
                                <div class="col-md-6 mb-4">
