...
$(document).on('submit', '#addCate', function (e) {
    e.preventDefault();

    var formData = new FormData(this);
    formData.append("add_cate", true);
...
$(document).on('click', '.deleteCateBtn', function () {
...
$(document).on('submit', '#editCate', function (e) {
    e.preventDefault();

    var formData = new FormData(this);
    formData.append("edit_cate", true);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (res.status == 422) {
                ...
                $('#editCate').load(location.href + " #editCate");
                alert(res.message);
            } 
            else if (res.status == 500) {
                alert(res.message);
...
$(document).on('click', '.deleteSuppBtn', function () {
...
$(document).on('submit', '#addSupp', function (e) {
    e.preventDefault();

    var formData = new FormData(this);
    formData.append("add_supp", true);
...
$(document).on('submit', '#editSupp', function (e) {
    e.preventDefault();

    var formData = new FormData(this);
    formData.append("edit_supp", true);
