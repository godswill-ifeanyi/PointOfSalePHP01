      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <button onclick="window.location.href='add-categories.php'" class="btn btn-primary btn-sm my-3 " style="float: right; width: 160px;">Add New</button>
                  ...
                  <tbody>
                    ...
                    <td class="align-middle text-left">
                      ...
                      <td class="align-middle text-center text-sm">
                        <button class="badge badge-sm bg-gradient-success border-0" onclick="return window.location.href='edit-categories.php?id=<?=$item['id']?>'">Edit</button>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <button class="badge badge-sm bg-gradient-danger deleteCateBtn border-0" value="<?= $item['id']?>">Delete</button>
                      </td>
                    </tr>
                  <?php
                    }
